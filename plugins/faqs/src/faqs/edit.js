...
export default function Edit({ attributes, setAttributes }) {
	...
	return (
		<>
			<InspectorControls>
				<PanelBody title={ __( 'Margin Controls', 'faqs' ) }>
					<ToggleControl
						__nextHasNoMarginBottom
						label={ __( 'Margin Top', 'faqs' ) }
						help={
							topmargin
								? __( 'Has top margin.', 'faqs' )
								: __( 'No top margin.', 'faqs' )
						}
						checked={ topmargin }
						onChange={ ( val ) => {
					...
					<ToggleControl
						__nextHasNoMarginBottom
						label={ __( 'Margin Bottom', 'faqs' ) }
						help={
							bottommargin
								? __( 'Has bottom margin.', 'faqs' )
								: __( 'No bottom margin.', 'faqs' )
						}
