						...
						{ variant === 'media-text-media-carousel' ? (
							<>
								...
								>
									...
									>
										<button type="button" aria-label="Previous slide" className="splide__arrow splide__arrow--prev c-arrows__arrow c-arrows__arrow--prev">
											<svg
												viewBox="0 0 20 14"
												fill="none"
										...
										<button type="button" aria-label="Next slide" className="splide__arrow splide__arrow--next c-arrows__arrow c-arrows__arrow--next">
											<svg
												viewBox="0 0 20 14"
												fill="none"
												xmlns="http://www.w3.org/2000/svg"
