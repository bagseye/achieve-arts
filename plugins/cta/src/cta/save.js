...
export default function save( { attributes } ) {
	...
	const innerBlocksProps = useInnerBlocksProps.save( {
		className: `${ blockname }__content d-typography js-anim h-animate-in-slide-up`,
	} );
	return (
		<section { ...blockProps }>
			<div className={ `${ blockname }__inner` }>
					...
					<div className={ `${ blockname }__items` }>
						<div className={ `${ blockname }__item` }>
							<header className={ `${ blockname }__header` }>
								<span className={`${ blockname }__tab h-tab js-anim h-animate-in-fade`}>
								<RichText.Content
									tagName="p"
									value={ tab }
								/>
						...
						{ mediaId && mediaUrl ? (
							<div className={ `${ blockname }__media js-anim h-animate-in-fade` }>
								<picture>
									<img
				...
				<div className={ `${ blockname }__bg js-anim h-animate-in-fade` }>
